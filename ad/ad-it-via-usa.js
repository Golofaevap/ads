...
function _generateRand() {
    var firstNumber = 75 + Math.round(Math.random() * 20);
    var secondNumber = 100 + Math.round(Math.random() * 820);

    var number1 = " " + firstNumber + "." + secondNumber + "р. ";
    var number2 = " " + firstNumber + secondNumber + "р. ";
    var number3 = " " + firstNumber + secondNumber + "р ";
    var number4 = " " + firstNumber + "," + secondNumber + "р. ";
    var number5 = " " + firstNumber + "," + secondNumber + "р. ";
