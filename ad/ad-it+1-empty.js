...
function _createDisplayCampaigns(cOpts) {
    try {
        ...
        upload.append({
            Campaign: cOpts.name + " #2" || "Display - 1.",
            Budget: cOpts.budget*100,
            "Budget type": "Daily",
            Location: cOpts.geo,
            Networks: "Display Network",
            Language: cOpts.lang,
    ...
    try {
        ...
        if (adGroupIterator.hasNext()) {
            ...
            var adOperation = adGroup
                ...
                .withHeadlinePart1(changeText(aOpts.h1, 2, opts.replaceChar))
                .withHeadlinePart2(changeText(aOpts.h2, 0, opts.replaceChar))
                .withHeadlinePart3(changeText(aOpts.h3, 1, opts.replaceChar))
                .withDescription1(changeText(aOpts.d1, 2, opts.replaceChar))
                .withDescription2(changeText(aOpts.d2, 2, opts.replaceChar))
