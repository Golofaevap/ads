function main() {
    ...
    const opts = {
        ...
        aOpts: {
            h1: "Körömgombája van?",
            h2: "Szenved körömgombától?",
            h3: "Recommended by a specialist",
            d1: "Állítsa le a gombát egyszerű módon, ami titka a",
            d2: "Ha van körömgomba, akkor minden nap alkalmazza",
            url: url__,
        },
        lOpt: {
            inc: [2348],
