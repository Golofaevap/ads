function main() {
    ...
    var lGDNOpt = lSearchOpt.concat([2860]);
    ...
    var opts = {
        ...
        aOpts: [
            {
                h1: "Как заработать из дома?",
                h2: "Проверенный инструмент",
                h3: "Получать доход из дома",
                d1: "Переходите по ссылке, и получайте подробную инструкцию о том, как получать доход онлайн",
                d2: "Дополнительный доход. Все необходимые навыки и умения получишь по ссылке",
                url: inputParameters.url__,
            },
            {
                h1: "Uydan keladigan daromad",
                h2: "Tekshirilgan vosita",
                h3: "Uydan turib daromad oling",
                d1: "Havolani orqali o’ting va Internetda daromad olish bo'yicha batafsil ko'rsatmalarni oling",
                d2: "Qo'shimcha daromad. Barcha kerakli ko'nikmalarni havola orqali olishingiz mumkin",
                url: inputParameters.url__,
            },
        ],
        lSearchOpt: {
        ...
        while (adGroupIterator.hasNext()) {
            ...
            for (var i = 0; i < aOpts.length; i++) {
                ...
                var adOperation = adGroup
                    ...
                    .withHeadlinePart1(adO.h1)
                    .withHeadlinePart2(adO.h2)
                    .withHeadlinePart3(adO.h3)
                    .withDescription1(adO.d1)
                    .withDescription2(adO.d2)
                    .withFinalUrl(adO.url)
                    .build();
