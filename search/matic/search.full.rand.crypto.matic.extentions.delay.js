...
function _createSearchCampaigns(opts, labels, constants) {
    ...
    try {
        ...
        if (!campaignIterator.hasNext()) {
            ...
            upload.append({
                Action: "add",
                Campaign: cOpts.name + Math.round(Math.random() * 9999999) || "Search-1.",
                Budget: cOpts.budget,
                "Budget type": "Daily",
                Networks: cOpts.network,
                Language: cOpts.lang,
...
function getOpts(inputParameters, targetedCountries, _bgtLevel, adjust, budgetMultiplier, time) {
    ...
    var opts = {
        ...
        aOpts: {
            h1: ["Matic Network Home", "Matic Network Connect", "Matic Network Start Now", "Matic Network Web Connect"],
            h2: ["Polygon Web", "Polygon Web Wallet v2", "Polygon Connect and Start Now"],
            h3: ["Fast safe Web Access", "Information online", "Connect With Web"],
            d1: [
                "Matic Network Safe & Secure Get Information. Fast & safe Web Access",
                "Matic Network Safe & Secure Get Information",
                "Matic Network near you. Fast Access & secure. Manage your wallet assets.",
            ],
            d2: [
