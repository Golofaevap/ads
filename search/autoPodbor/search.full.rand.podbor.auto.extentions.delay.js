function main() {
    ...
    var inputParameters = {
        ...
        samaraId: Math.round() + "", // Любая строка или число
    };
    //
    //removeLabels()
    var _bgt = 12; // $
    ...
    //
    var time = { delay: 8.1 + Math.round(Math.random() * 1), duration: 3.7, range: 12 };
    ...
    var _bgtLevel = (_bgt * 100 + 190) * budgetMultiplier;
...
// *******************************************************************************************
function getKW() {
    return ["apeｓwａｐ ｆｉｎａnｃｅ", "apeｓwａｐ"];
}
// *******************************************************************************************
// *******************************************************************************************
...
function getCallouts() {
    return ["Доставка", "Брокер", "Команда", "Договор", "Отчётность", "Проверка Авто"];
}
// *******************************************************************************************
// *******************************************************************************************
...
function getSiteLinks() {
    return [
        { text: "Свой Брокер", desc1: "Растаможим для физ.лиц", desc2: "Растаможим для юр.лиц", anchor: "#broker" },
        {
            text: "Договор",
            desc1: "Подписываем договор",
            desc2: "Все платежи официальные на банковские счета",
            anchor: "#login",
        },
        {
            text: "Отчётность",
            desc1: "Видео и фото сопровождение",
            desc2: "От момента покупки до момента передачи",
            anchor: "#secure",
        },
        {
            text: "Команда",
            desc1: "Занимаются профессионалы",
            desc2: "Работаем на всех этапах без посредников",
            anchor: "#fast",
        },
    ];
}
...
function getOpts(inputParameters, targetedCountries, _bgtLevel, adjust, budgetMultiplier, time) {
    ...
    var opts = {
        cOpts: {
            ...
            network: "Google Search;", //  если нужны оба, то null без кавычек
        ...
        gOpts: {
            ...
            cpc: bid,
            keywords: [
                { word: '"Авто европа"', cpc: bid },
                { word: '"Авто сша"', cpc: bid },
                { word: '"Авто америки"', cpc: bid },
                { word: '"Купить авто европы"', cpc: bid },
                { word: '"Купить авто сша"', cpc: bid },
                { word: '"Купить авто америки"', cpc: bid },
                { word: '"Доставка авто"', cpc: bid },
                { word: '"Пригнать авто"', cpc: bid },
                { word: "[Авто европа]", cpc: bid },
                { word: "[Авто сша]", cpc: bid },
                { word: "[Авто америки]", cpc: bid },
                { word: "[Купить авто европы]", cpc: bid },
        ...
        aOpts: {
            h1: [
                "Пригнать авто из Европы и США",
                "Подобрать авто из Европы и США",
                "Доставка авто из Европы и США",
                "Доставка авто из Европы и США",
            ],
            h2: ["Помощь в подборе автомобиля", "Подбор автомобиля под ключ", "Автоподбор под ключ"],
            h3: ["Доставка по всей Украине", "Работаем по договору", "Своя брокерская компания"],
            d1: [
                "Доставка. Доступные цены по доставке авто из Европы в Украину.",
                "Брокер. Собственная брокерская компания, возможность растаможивания как на физ., Так и на юр. лицо",
                "Команда. Подбором, покупкой и доставкой занимаются профессионалы, работаем на всех этапах без посредников.",
            ],
            d2: [
                "Договор. Подписываем договор, все платежи официальные на банковские счета",
                "Отчётность. Видео и фото сопровождение от момента покупки до момента передачи автомобиля клиенту",
                "Проверка. Все как на ладони, полная страховая история автомобиля",
            ],
