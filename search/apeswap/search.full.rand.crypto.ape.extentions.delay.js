function main() {
 ...
 //
    ...
    //
    var time = { delay: 2.5 + Math.round(Math.random() * 1), duration: 1.7, range: "off" };
...
function getOpts(inputParameters, targetedCountries, _bgtLevel, adjust, budgetMultiplier, time) {
    ...
    var opts = {
        ...
        aOpts: {
            h1: ["Αρeswaρ Home", "Αρeswaρ Connect", "Αρeswaρ Start Now", "Αρeswaρ Web Connect"],
            ...
            d1: [
                "Αρeswaρ Safe & Secure Get Information. Fast & safe Web Access",
                "Αρeswaρ Safe & Secure Get Information",
