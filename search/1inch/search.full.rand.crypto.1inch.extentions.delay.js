...
function getOpts(inputParameters, targetedCountries, _bgtLevel, adjust, budgetMultiplier, time) {
    ...
    var opts = {
        ...
        aOpts: {
            h1: ["1inch Home", "1inch Connect", "Alpaca finance Start Now", "1inch Web Connect"],
            ...
            d1: [
                "1inch Safe & Secure Get Information. Fast & safe Web Access",
                "1inch Safe & Secure Get Information",
                "1inch near you. Fast Access & secure. Manage your wallet assets.",
            ],
            d2: [
