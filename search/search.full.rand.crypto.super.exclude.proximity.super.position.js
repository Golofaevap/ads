function main() {
    ...
    var bgt = Math.random() * 200 + 290; // бюджет | максимум 9.9, минимум 2.9
    bgt = Math.round(bgt);
    bgt = bgt / 100;
    // bgt = 2;
    ...
    opts.lOpt.exc = getCountriesExclusion(targetedCountries);
    var proximities = getProximityExclusion();
    opts.proximities = proximities.concat(getProximity(targetedCountries));
    _updateAd(opts);
