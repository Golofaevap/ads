function main() {
    ...
    const inputParameters = {
        url__: "",
        trackingUrl__: "",
        countriesStr: "", // australia;austria;belgium;canada;denmark;finland;france;germany;ireland;italy;luxembourg;netherlands;new zeland;norway;spain;sweden;switzerland;united kingdom;united states
    ...
    var _bgtLevel = (_bgt * 100 + 90) * getBudgetMultiplier();
    var opts = getOpts(inputParameters, targetedCountries, _bgtLevel, adjustText);
...
// *******************************************************************************************
// *******************************************************************************************
function getOpts(inputParameters, targetedCountries, _bgtLevel, adjust) {
